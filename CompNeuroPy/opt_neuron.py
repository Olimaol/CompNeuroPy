...
class opt_neuron:
    ...
    def __init__(
        ...
        get_loss_function,
        variables_bounds,
        time_step=None,  # TODO implement if timestep is None --> get it from results and test loss function with two time results_soll otherwise do not test loss function with two times results_soll
        ...
        Args:
            results_soll: dict
                a results dictionary with recordings from the experiment (target results) (if results_soll were generated by the provided experiment)
                or something which contains the target data and can be used by the get_loss function

                Do not define a time_step if results_soll were generated by the provided experiment!
            ...
            time_step: float
                ...
                if none is provided, it is assumed that results_soll were generated by the provided experiment and contain the time step in the recordings
