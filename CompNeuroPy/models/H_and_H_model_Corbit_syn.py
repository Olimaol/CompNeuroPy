...
class H_and_H_model_Corbit_syn(generate_model):
    ...
    def __init__(self, name='model', do_compile=False, compile_folder_name='annarchy'):
        ...
        """
        description = 'One population "HH_Corbit" with two neurons of the H & H neuron model of Corbit et al. (2016) with conductance based synapses'
    ...
    def __model_creation_function__(self):
        pop = Population(2, neuron=H_and_H_Corbit_syn, name='HH_Corbit')
